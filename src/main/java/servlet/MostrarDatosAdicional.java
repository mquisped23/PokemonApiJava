 ...
 * @author andro
 */
public class MostrarDatosAdicional extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Recupero el id de mi jsp Pokemones
        ...
        //for (int i = 1; i <= 9; i++) {
            ...
            CloseableHttpResponse respuesta = client.execute(new HttpGet("https://pokeapi.co/api/v2/pokemon/"+id));
